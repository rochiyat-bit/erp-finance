...
export default function PaymentsPage() {
  ...
  const filteredPayments = payments.filter(
    (payment) =>
      ...
      payment.vendor.vendorName.toLowerCase().includes(search.toLowerCase())
  );
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <Link href="/ap/payments/new">
                <Button className="mt-4">Create First Payment</Button>
              </Link>
            </div>
          ) : (
                ...
                <tbody>
                  {filteredPayments.map((payment) => (
                    <tr key={payment.id} className="border-b hover:bg-muted/50">
                      ...
                      <td className="p-2">{payment.vendor.vendorName}</td>
                      <td className="p-2">
                      ...
                      <td className="p-2 text-center">
                        <Link href={`/ap/payments/${payment.id}`}>
